...
<ProductScreenshot name="docs-automations" alt="An empty Murage automations calendar ready for its first schedule" caption="Review work across a day, three-day, or week view and filter by bot." />
