...
extension EmberState {
    ...
    static func normalize(_ value: String?) -> EmberState? {
        guard let value, !value.isEmpty else { return nil }
        return EmberState(rawValue: value) ?? legacy[value]
    }

    static func forBot(_ bot: Bot, last: Message?) -> EmberState {
    ...
    static func forChat(_ chat: Chat, in state: CompanionState) -> EmberState {
        switch chat {
