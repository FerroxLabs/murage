...
OpenMausMobile is a companion for the Murage desktop application. The
...
1. Install and start Murage on a Mac, Windows, or Linux computer.
...
6. In Safari, Notes, Photos, or Files, open the system Share sheet and choose
   **Murage**. The extension shows the paired computer and asks for a bot
...
specific computer and receives no universal Murage account credential.
The reviewer may use any email inbox they control. This optional path uses an
Murage-managed Cloudflare Tunnel and does not require Tailscale.
