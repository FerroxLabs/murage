...
# lens-platform-native

**Lens mode.** Source authority: Gary Vee's "day-trading attention" thesis — the same idea performs differently on every platform, and the platform's native shape is non-negotiable.
...
- Emotional trigger: ...
- Native format: ...
- Why care (on this surface): ...
- Opening line: ...

## Decision rules

- **Use this lens last, after the idea is solid.** Platform-native framing is a finish, not a start. If the underlying insight is weak, platform-tuning amplifies the weakness.
- **One platform per pass.** Adapting to three platforms simultaneously produces a middle-distance asset that fits none. Run this lens three times, once per surface.
- **Match the reader's posture.** A reader scrolling TikTok at midnight will not read a 300-word LinkedIn-style intro. A reader on LinkedIn at 10am will not respond to a TikTok-style cold open.
- **Skip this lens for evergreen owned-channel assets.** Long-form blog posts, course modules, and docs do not need platform-native tuning; they need clarity and structure.
- **Don't fake nativeness.** A LinkedIn post that imitates "thought-leader" tropes without owning them reads worse than a plain version of the same idea.

## Anti-patterns

- **Impersonation.** Writing in "platform-creator voice" — "okay so here's the thing nobody talks about" — without earning it. Cadence-cosplay underperforms plain writing.
