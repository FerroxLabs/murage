...
Use when Instagram is on the channel mix and you need to decide what role it plays in the stage map, what formats serve which stages, and how to spec creative without inventing platform mechanics. Use when the brief says "post on Instagram more" without a stage assignment.
...
- Quoting platform tactics from blog posts dated before 2024. Reach mechanics and format priorities have shifted; demand fresh sources.
