...
- **Use this lens for operator audiences**, not consumer audiences. A reader buying a course on personal habits cares about identity and outcome; an operator buying the same course cares about ROI and time recovered. Frame for the actual reader.
- **Boring beats clever.** "Bought a self-storage facility for $340k, throws off $58k/year" travels further than "I disrupted the storage industry." Numbers carry the weight.
- **Skip this lens for emotional or narrative pieces.** Forcing a monetization angle onto a personal story flattens it.
- **One impact metric, not five.** If the reader has to remember three numbers to remember the post, they will remember none.
- **Real numbers or no numbers.** Inventing plausible-looking figures destroys trust faster than vague language does.

## Anti-patterns

- **Impersonation.** Adopting an "I'm-just-here-for-the-cash-flow" persona without owning the underlying analysis. Operators sniff out larping immediately.
- **Hustle theatre.** Big round numbers, no breakdown, no source. "$1M in 90 days" with no mechanics reads as bait, not as insight.
- **Generic operator filler.** "Run lean, focus on ROI, hire slow, fire fast." Read by everyone, remembered by no one. Replace with the specific lesson and the specific number.
- **Systematizing the un-systematizable.** Pretending a one-off insight is a "framework you can apply to your business" when it isn't. Operators notice; trust drops.
- **Monetization as the entire frame.** If every paragraph is about money, the asset reads as a pitch. Money is one lens of four; the others have to show up.
