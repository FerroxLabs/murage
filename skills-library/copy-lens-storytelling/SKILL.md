...
**Lens mode.** Source authority: Steven Bartlett's "diary"-format storytelling — emotional honesty, scene-led narration, the turning-point structure.
...
- **Use this lens when the reader needs emotional traction**, not when they need information. A how-to article wrapped in a story usually fails as both; a story used to deliver one decisive insight usually wins.
- **Small turns over big ones.** The believable shift moves the reader. The cinematic shift bounces off.
- **First person almost always.** Third-person founder-stories read as PR. If the author cannot speak in first person, write in observed first person ("I watched her do this") not third.
- **Skip this lens for transactional copy.** A cart-abandonment email does not need an origin story.
- **One arc per asset.** Two stories braided together dilute both.

## Anti-patterns

- **Impersonation.** Adopting a confessional cadence ("I want to be honest with you all…") without the actual confession behind it. Readers can tell.
- **Inspirational mush.** "I learned that the only thing holding me back was me." Reads as a fortune cookie. Replace with the specific action that proved the lesson.
- **Hero-journey cosplay.** Forcing a real, messy situation into a 12-step monomyth. The reader feels the scaffolding and disengages.
- **Trauma display without insight.** Detail of suffering is necessary; insight is what makes the suffering useful to the reader. Without insight, the story reads as a vent.
- **Emotional tone-mixing.** Defiance in paragraph one, gratitude in paragraph two, grief in paragraph three. Pick one. Edit toward it.
