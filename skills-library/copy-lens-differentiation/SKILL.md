...
- **Use this lens when the topic is saturated**, not when it is novel. On a novel topic, the obvious version is already differentiated; this lens is overkill.
- **Different ≠ wrong.** Being contrarian for the sake of contrarianism produces takes that age into embarrassment in six weeks. The angle has to be defensible on the merits.
- **Earn it with specificity.** A vague contrarian claim ("most advice is wrong") is just edgelording. A specific one ("most cold-email advice optimizes for reply rate at the cost of pipeline quality, and here is the math") earns the position.
- **Skip this lens for educational or transactional copy.** Differentiation in a how-to article reads as showmanship.
- **One contrarian claim per asset.** Two competing contrarian claims read as flailing.

## Anti-patterns

- **Impersonation.** Affecting a manifesto cadence ("Here is what nobody is telling you…") without doing the underlying work. Reads as posture.
- **Edgelording.** Taking the most disagreeable possible position because it gets engagement, not because it is true. Earns clicks, loses the right readers.
- **Faux-contrarian frames around consensus claims.** "Unpopular opinion: customers matter." This is not contrarian; it is the consensus with a hat on.
- **Differentiation without a thesis.** Listing five things you are "tired of seeing" without proposing what should replace them. Critique without construction reads as venting.
- **Contrarian-for-the-niche.** A claim that is contrarian inside one tiny pocket but obvious to everyone else. Test the position against the broader audience the asset actually reaches.
