---
name: copy-lens-curiosity-packaging
description: "**Lens mode.** Source authority: MrBeast-era retention frameworks — pattern interrupt, tension, payoff."
metadata:
  author: wayland
  version: "1.0.0"
  category: "copy"
...
# lens-curiosity-packaging

**Lens mode.** Source authority: MrBeast-era retention frameworks — pattern interrupt, tension, payoff.
...
- **Use this lens when attention is the bottleneck**, not when conviction is. If the reader already clicked, packaging is the wrong fix — they need a clarity or value pass.
- **Bigger gap is not always better.** Gaps must be closable in the body. A title that promises more than the asset delivers earns one click and zero trust.
- **Specificity beats spectacle.** "I sent 47 cold emails in one Saturday" beats "I sent INSANE amounts of cold email." Concrete numbers do the curiosity work.
- **One transformation per asset.** If the packaging implies two outcomes, the reader picks neither.
- **Skip this lens for most-aware audiences.** They came to act, not to be intrigued. Packaging gets in the way.

## Anti-patterns

- **Impersonation.** Writing "MrBeast-style" titles by copying surface mannerisms (all caps, "I", emoji). The discipline is gap engineering, not the costume.
- **Clickbait gaps the body cannot close.** Promising a number, a secret, or a turnaround the asset does not contain. Earns one click; loses the next ten.
- **Topic dressed as transformation.** "How to write better emails" is a topic. "The first sentence that doubled my reply rate" is a transformation. One reads as homework; the other reads as a payoff.
- **Five rephrasings of one title.** If all five options share the same noun, verb, and number, you wrote one title with five hats.
- **Curiosity without stakes.** A gap that resolves in a yawn ("you won't believe which fonts I like") is not a gap, it is filler.
