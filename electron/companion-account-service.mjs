...
export const DEFAULT_COMPANION_CONTROL_PLANE_URL = "https://accounts.murage.ai";
...
const INSTALLATION_CREDENTIAL = /^murage_install_[A-Za-z0-9_-]{22}\.[A-Za-z0-9_-]{43}$/;
...
export function resolveCompanionControlPlaneURL({
  ...
  if (Object.hasOwn(environment, "MURAGE_CONTROL_PLANE_URL")) {
    return normalizeControlPlaneURL(environment.MURAGE_CONTROL_PLANE_URL);
  }
...
const FRIENDLY_MESSAGES = Object.freeze({
  ...
  network_unavailable: "Murage could not reach its secure connection service. Check your internet and try again.",
