...
it.runIf(process.platform === "darwin")("diagnoses early-empty navigation after Chromium load completion", async () => {
  ...
  expect(result.stdout).toContain("actual-host-navigation-early-empty-reproduced; private-network-block-preserved");
