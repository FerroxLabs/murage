...
test("independent password reference persists metadata only and returns bytes only to host",async t=>{
...
test("changed file requires explicit reselection and does not reveal new content",async t=>{
