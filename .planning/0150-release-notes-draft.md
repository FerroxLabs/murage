...
- Windows source `15c3cbd6` has a signed, hash-verified private installer and ZIP. Installation, uninstallation and the agreed bundled native workloads are still being qualified by the guest owner. Do not label them passed from the build or signature receipt alone.
