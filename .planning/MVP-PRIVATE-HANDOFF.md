...
| Native Mac launch and quit | ✅ Done | Final 7ba8095c/0.1.47-mvp.2 artifact opens isolated fixture and quits with exit code 0 after owner granted Keychain permission. All captured children gone within bounded teardown; confirmation55378 passed. |
...
1. Mac continuation is complete: preserve real OS home/Keychain while isolating
   application data. Wait up to three seconds for OS child reaping after normal
   exit. No production-code shutdown change was needed; no full-suite rerun.
