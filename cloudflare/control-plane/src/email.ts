...
const SUBJECTS = {
  "sign-in": "Your Murage sign-in code",
  "email-verification": "Verify your Murage email",
  "forget-password": "Reset your Murage password",
  "change-email": "Confirm your Murage email change",
