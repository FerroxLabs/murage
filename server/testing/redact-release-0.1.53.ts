// The text redaction of the SHIPPED 0.1.53 release, verbatim — server/redact.ts
// at origin/release/v0.1.53 (03e053da5b7c31146b715b1c55f2508d6cc2eba1) — kept
// here as the oracle for the differential tests in server/drivers/acp/acp.test.ts.
//
// Those tests ask one question of every change to the engine-error pipeline:
// does the branch ever print material the shipped release masked? Answering it
// needs the shipped rules themselves, not a description of them: round 9's
// guard suite was green while a PEM body leaked, because it pinned the rules
// the author had in mind and no test held the rule set as a whole. Do not
// edit this file to follow server/redact.ts; it is the fixed point the live
// file is measured against. Regenerate only from the release ref:
//   git show origin/release/v0.1.53:server/redact.ts
// (the comment block above this line is the only addition).
