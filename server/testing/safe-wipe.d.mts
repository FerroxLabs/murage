...
/** The path a node:fs delete names, from a string, `file:` URL, URL-like value (fs duck-types any object or function with truthy `{ href, protocol }` and deletes its `pathname`) or Buffer, for the guard's judgement. */
