  ...
  return (
    ...
    >
      <div
        ...
        className="flex max-h-[min(480px,calc(0.7*var(--vvh,100dvh)))] w-full max-w-[560px] flex-col overflow-hidden rounded-xl border border-hairline/50 bg-card shadow-2xl shadow-black/60"
      >
