...
export function KeyboardShortcutsDialog({ open, onClose, returnFocusRef }: {
  ...
  const firstControl = useRef<HTMLButtonElement>(null), lastControl = useRef<HTMLButtonElement>(null);
