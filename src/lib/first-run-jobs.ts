...
export interface FirstRunJobWorld {
  ...
  /** Nothing here can answer a question right now. Computed server-side over
   *  `runnable()`, never re-derived here: see `SetupView`. A signed-out
   *  engine counts as nothing, because it is. */
