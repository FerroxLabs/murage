...
// ~/.murage would be reaching into somebody else's data layout — the
...
/** MURAGE_COMPANION_DIR isolates a test rig from a real paired fleet. */
export const DATA_DIR = process.env.MURAGE_COMPANION_DIR ?? join(homedir(), ".murage-companion");
