...
const output = new URL("../test-results/0150-intel-native/darwin-x64.json", import.meta.url);
...
await mkdir(new URL("../test-results/0150-intel-native/", import.meta.url), { recursive: true });
