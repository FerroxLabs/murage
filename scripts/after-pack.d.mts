...
export function validatePackagedThumbnailRuntime(server:string,manifest:{packages?:{name:string;version:string;path:string}[]},platform:string,arch:string):Promise<{package:"sharp";version:string;files:string[]}>;
