...
const IMAGE = process.env.MURAGE_DEB_SMOKE_IMAGE || "ubuntu:24.04";
const RUNTIME = process.env.MURAGE_DEB_SMOKE_RUNTIME || "docker";
...
const staged = "/root/pending dir/o'brien/Murage.deb";
...
const installed = inContainer(
  [
    ...
    'test -x /opt/Murage/murage && echo "EXECUTABLE=yes"',
  ].join("\n"),
);
