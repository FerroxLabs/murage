...
const resources = process.env.MURAGE_CUA_RESOURCES ?? join(root, "dist-native", hostArch);
process.env.MURAGE_CUA_SDK_LIBRARY = join(resources, "cua-sdk/native/libcua_driver_sdk.dylib");
...
const host = new EmbeddedCuaDriverHost(binary, "com.murage.app");
let proxy;
...
try {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "murage-package-smoke", version: "1" },
  });
